...
public :
	...
	*/
	...
	/**
		...
		@param profondeur:int, la profondeur d'affichage du compte pour la récurrence
	*/
	...
	/**
		...
		@param n: const string&, une chaine de caractère correspondant à un nom de compte
	*/
