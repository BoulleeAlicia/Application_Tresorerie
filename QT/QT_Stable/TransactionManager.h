...
public:
	...
	*/
	...
	/**
		...
		@return Rien.
	*/
    void ajouterTransaction (const QDate& d,const int r, const string& m, bool marque, vector<Operation*>o);
	/**
	...
	*/
    ...
    void afficherTransactionsQT(QTableWidget* t);

    void afficherSurQcombobox(QComboBox* c);
