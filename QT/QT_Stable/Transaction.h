...
class Transaction{
  ...
  private:
    ...
    */
    Transaction(const QDate& d, int r, const string& me, bool ma, vector<Operation*> o) : date(d), reference(r), memo(me), marque(ma), operations(o) {}
    /**
    ...
    */
    ...
    //void Supprimer_Vector_Operations ( Transaction* transaction );
